...
Testy uruchomiono poleceniem \texttt{python manage.py test}. Wykonywane były testy automatyczne aplikacji (testy jednostkowe i integracyjne) zdefiniowane w projekcie. Oczekiwanym wynikiem było pomyślne zakończenie całego zestawu testów bez błędów i niepowodzeń. Wszystkie testy zakończyły się poprawnie.
